...
enum Value {
  ...
  _PawnValueMg   = 198,   _PawnValueEg   = 258,
  _KnightValueMg = 817,   _KnightValueEg = 846,
  _BishopValueMg = 836,   _BishopValueEg = 857,
  _RookValueMg   = 1270,  _RookValueEg   = 1278,
  _QueenValueMg  = 2521,  _QueenValueEg  = 2558,
