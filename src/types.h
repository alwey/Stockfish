...
enum Value {
  ...
  PawnValueMg   = 194,   PawnValueEg   = 258,
  KnightValueMg = 784,   KnightValueEg = 854,
  BishopValueMg = 836,   BishopValueEg = 874,
  RookValueMg   = 1219,  RookValueEg   = 1304,
  QueenValueMg  = 2420,  QueenValueEg  = 2584,
